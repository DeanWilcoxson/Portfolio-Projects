...
let potion = new Item("Healing Potion",`Replenish your weary soul(Adds 500 to Health).`,10);
let bomb = new Item("Dynamite!",`A good way to keep enemies at bay! (Inflicts 750 damage to enemy health).`,15);
let attackUp = new Item("Carinthian Tonic","Gain Immense Power (Attack Power + 250)",25);
let defenseUp = new Item("BonTooine Tonic","Rock Solid Defense (Defense + 500)",25);
...
let claw = new Weapon("Claws", .75, 25, 20, false);
...
shop.weapons.push(demonTide,longSword,cleaver,handOfGod,fatalKiss,fistOfJudgement,claw,teeth,greatSword,fist,horns);
...
let fira = new CreateSpell("Fira", "Inflict burn ailment", 50, "Five", "Two", 25)
let blizzara = new CreateSpell("Blizzara", "Inflict freeze ailment", 50, "Five", "Two", 25)
let thundara = new CreateSpell("Thundara", "Inflict shock ailment", 50, "Five", "Two", 25)
shop.spells.push(fira,blizzara,thundara)
